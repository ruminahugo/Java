	...
	MainForm() {
        ...
        open.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) { 
            	...
            	SecondForm frm = new SecondForm(MainForm.this);
		...
		center.setLayout(new GridLayout(5, 1, 0, 5));
		...
		try {
		    ...
		    Image icon = Toolkit.getDefaultToolkit().getImage("assets/LOGO AU LAC.png");
